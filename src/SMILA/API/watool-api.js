...
/**
 * Web Automation Tools v0.0.1-SNAPSHOT
 */
angular.module('watool-api', [])
...
.config(['ApiProvider', function(ApiProvider) {
  ApiProvider.setApiBaseUrl('https://127.0.0.1:3005/0.0.1-SNAPSHOT/');
}])


.factory('WorkerApi', ['Api', function(Api) {
  return {
    
    /**
     * Web Automation Tools Workers
     */
    query: function(query) {
      return Api.get('/workers', null, query);
    }
